...
pub fn roulette_wheel_selection<U:ChromosomeT>(chromosomes: &Vec<U>) -> HashMap<usize, usize>{
...
pub fn stochastic_universal_sampling<U:ChromosomeT>(chromosomes: &Vec<U>, couples: i32) -> HashMap<usize, usize>{
