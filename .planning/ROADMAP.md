...
- ✅ **v3.0.0 — Advanced Representations, Alternative Strategies & Architecture Simplification** — Phases 47-84 (shipped 2026-06-23)
...
<details>
<summary>✅ v3.0.0 — Advanced Representations, Alternative Strategies & Architecture Simplification (Phases 47-84) — SHIPPED 2026-06-23</summary>
...
- [x] **Phase 47: Architecture Audit & ChromosomeT Split** — Reduce `ChromosomeT` to a minimal core; introduce `LinearChromosome` supertrait; remove `Reporter<U>`; apply 6 API simplifications; validate all 10 examples compile and run in CI
- [x] **Phase 48: New Genotype Types** — `UniqueChromosome<T>`, `MultiRangeChromosome<T>`, `MultiUniqueChromosome<T>`
- [x] **Phase 49: Unified Strategy Trait + Alternative Strategy Engines** — `Strategy<U>` trait; `HillClimbEngine`; `PermutateEngine`
- [x] **Phase 50: Lexicase Selection** — `LexicaseSelection`; epsilon-lexicase variant
- [x] **Phase 51: Multi-Parent Crossover + Self-Adaptive Mutation** — UNDX, SPX, PCX; `SelfAdaptiveGaussian`
- [x] **Phase 52: Variable-Length Chromosomes** — `ChromosomeLength::Variable`; Insertion/Deletion mutation
- [x] **Phase 53: Tree Chromosome + GpGa Engine** — `TreeChromosome`; `GpGa<U>` engine
- [x] **Phase 54: N-ary Selection / Per-Operator Mutation Params**
- [x] **Phase 55: RFC Multi-Valued Fitness (VectorFitness)**
- [x] **Phase 56: CMA-ES Engine** — `CmaEngine<U>` with IPOP/BIPOP restart
- [x] **Phase 57: PSO Engine** — `PsoEngine<U>` with configurable topology
- [x] **Phase 58: EDA / UMDA Engine** — `EdaEngine<U>` with Bernoulli/Gaussian
- [x] **Phase 59: Restart Strategies — IPOP / BIPOP**
- [x] **Phase 60: Batch Fitness / Fitness Cache Extension**
- [x] **Phase 61: Performance — Clone Reduction & Parallel Survivor**
- [x] **Phase 62: Surrogate-Assisted Evaluation**
- [x] **Phase 63: Visualization — Pareto Front Plotting & Example Images**
- [x] **Phase 64: Test & Doc Quality**
- [x] **Phase 65: v3.0.0 Migration Guide & Release Notes**
- [x] **Phase 66: Build-perf foundations** — Baseline harness, feature-matrix CI, golden tests
- [x] **Phase 67: Build-perf M1 (config quick wins)** — Profile tuning, nextest, mold/lld, sccache
- [x] **Phase 68: Build-perf M2 (dep hygiene)** — Remove env_logger auto-install, `logging` feature
- [x] **Phase 69: Build-perf M3 (major refactors)** — criterion→divan, `parallel` feature, ga.rs split
- [x] **Phase 70: Replace Operator Downcasting (#247)**
- [x] **Phase 71: Per-Operator Mutation Params (#249)**
- [x] **Phase 72: Audit Ignored Doctests (#265)**
- [x] **Phase 73: Move Inline Test Modules (#266)**
- [x] **Phase 74: Add Missing Benchmarks (#267)**
- [x] **Phase 75: Reduce Clones / Reusable Offspring Buffers (#258)**
- [x] **Phase 76: Parallelize Survivor & Non-Dominated Sorting (#259)**
- [x] **Phase 77: Extend Fitness Cache to More Engines (#260)**
- [x] **Phase 78: Replace User-Input Panics with GaError (#279)**
- [x] **Phase 79: Add Runnable Examples (#281)**
- [x] **Phase 80: Document CmaEngine, PsoEngine, EdaEngine (#282)**
- [x] **Phase 81: Add Prelude Module (#283)**
- [x] **Phase 82: Per-Engine Convergence Integration Tests (#284)**
- [x] **Phase 83: Wire Lexicase Selection into GA Run**
- [x] **Phase 84: Fix v3.0.0 Tech Debt**

Full archive: `.planning/milestones/v3.0.0-ROADMAP.md`
...
### Phase 84: Fix all v3.0.0 milestone tech debt — code bugs, ROADMAP accuracy, integration warnings, missing VERIFICATION.md
...
<details>
<summary>v3.0.0 Phase Details (Phases 47-84)</summary>
...
| 73. Move Inline Test Modules (#266) | v3.0.0 | 4/4 | Complete | 2026-06-19 |
...
| 78. Replace User-Input Panics with GaError (#279) | v3.0.0 | 4/4 | Complete | 2026-06-19 |
| 79. Add Runnable Examples for GP, DE, Scatter, Cellular, ALPS (#281) | v3.0.0 | Complete | Complete | 2026-05-25 |
...
| 82. Per-Engine Convergence Integration Tests (#284) | v3.0.0 | 1/1 | Complete | 2026-06-22 |
| 83. Wire Lexicase Selection into GA Run | v3.0.0 | 2/2 | Complete | 2026-06-23 |
| 84. Fix v3.0.0 Tech Debt | v3.0.0 | — | Complete | 2026-06-23 |
